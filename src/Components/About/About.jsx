            ...
            <div className={`${style.aboutBackground}`}>
                <div className="container d-flex flex-column overflow-hidden">
                    ...
                    <div className="row mb-2">
                        <div className={`col-sm-6 col-lg-4 ms-auto`}>
                        ...
                        <div className={`col-sm-6 col-lg-4 me-auto`}>
                    ...
                    <button className={`mb-4 mx-auto text-capitalize p-3 rounded ${style.downloadButton} text-white`}><i className={`fa-solid fa-download me-3 text-white ${style.downloadSign}`}></i>free download!</button>
                </div>
            </div>
        </>
    )
